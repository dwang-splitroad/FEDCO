        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/small-business">
              <button className="px-6 py-3 text-base font-bold text-white bg-[#273776] hover:bg-[#1f2b5e] rounded-lg shadow-md hover:shadow-lg transition-all duration-200">
                View Business Assistance
              </button>
            </Link>
            <Link href="/sign-up">
              <button className="px-6 py-3 text-base font-bold text-secondary bg-white hover:bg-gray-100 rounded-lg shadow-md hover:shadow-lg transition-all duration-200">
                Sign Up for Updates
              </button>
            </Link>
          </div>
