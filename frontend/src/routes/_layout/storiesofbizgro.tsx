    ...
    <Box bg="gray.50" minH="100vh" py={10}>
      <Box bg="gray.50" p={{ base: 6, md: 12 }}>
        ...
        <Box>
          ...
          <Box bg="gray.50" p={{ base: 4, md: 8 }} mb={8} maxW="2xl" mx="auto">
            <Heading as="h2" fontSize={{ base: "2xl", md: "3xl" }} color="#e07a22" fontWeight="bold" mb={3}>Stories of BizGro: Newby Services</Heading>
            {/* Header/Feature Image */}
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/Newby+Services.png" alt="Newby Services Header" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_9213.jpg" alt="Rusty Newby Portrait" style={{ width: "100%", maxHeight: 340, objectFit: "cover" }} /></Box>
            ...
            <Flex gap={2} mb={4}>
              <Box flex={1}><img src="/images/storiesofbizgro/article pictures/OBS_9185.jpg" alt="Newby Services Truck 1" style={{ width: "100%", maxHeight: 120, objectFit: "cover" }} /></Box>
              <Box flex={1}><img src="/images/storiesofbizgro/article pictures/OBS_9186.jpg" alt="Newby Services Truck 2" style={{ width: "100%", maxHeight: 120, objectFit: "cover" }} /></Box>
              <Box flex={1}><img src="/images/storiesofbizgro/article pictures/OBS_9225.jpg" alt="Newby Services Truck 3" style={{ width: "100%", maxHeight: 120, objectFit: "cover" }} /></Box>
            </Flex>
            ...
            {/* Final Wide Image */}
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_9205.jpg" alt="Newby Services Wide Shot" style={{ width: "100%", maxHeight: 260, objectFit: "cover" }} /></Box>
          ...
          <Box bg="gray.50" p={{ base: 4, md: 8 }} mb={8} maxW="2xl" mx="auto">
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/Rochester+Boat+Company.png" alt="Rochester Boat Company Logo" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain", background: '#fff' }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_9109.jpg" alt="Rochester Boat Company Building" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_9093.jpg" alt="Rochester Boat Company Owners" style={{ width: "100%", maxHeight: 340, objectFit: "cover" }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_9172.jpg" alt="Rochester Boat Company Shop" style={{ width: "100%", maxHeight: 340, objectFit: "cover" }} /></Box>
          </Box>
          ...
          <Box bg="gray.50" p={{ base: 4, md: 8 }} mb={8} maxW="2xl" mx="auto">
            ...
            {/* Main header image */}
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/Rochester+Bagel_Kline+Performance+Equine_Blog+Header@300x.png" alt="Kline Performance Equine Header" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_8874.jpg" alt="Kline Performance Equine" style={{ width: "100%", maxHeight: 260, objectFit: "cover" }} /></Box>
            ...
            {/* Three images in a row */}
            <Flex gap={2} mb={4}>
              <Box flex={1}><img src="/images/storiesofbizgro/article pictures/OBS_8944.jpg" alt="Kline Performance Equine 1" style={{ width: "100%", maxHeight: 120, objectFit: "cover" }} /></Box>
              <Box flex={1}><img src="/images/storiesofbizgro/article pictures/OBS_8868.jpg" alt="Kline Performance Equine 2" style={{ width: "100%", maxHeight: 120, objectFit: "cover" }} /></Box>
              <Box flex={1}><img src="/images/storiesofbizgro/article pictures/OBS_8879.jpg" alt="Kline Performance Equine 3" style={{ width: "100%", maxHeight: 120, objectFit: "cover" }} /></Box>
            </Flex>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_8926-2.jpg" alt="Kline Performance Equine 4" style={{ width: "100%", maxHeight: 260, objectFit: "cover" }} /></Box>
          ...
          <Box bg="gray.50" p={{ base: 4, md: 8 }} mb={8} maxW="2xl" mx="auto">
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/Rochester+Bagel_Rochester+Bagel_Blog+Header@300x.png" alt="Rochester Bagel & Coffee" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
            ...
            <Flex gap={2} mb={4}>
              <Box flex={1}><img src="/images/storiesofbizgro/article pictures/OBS_8982.jpg" alt="Bagel Shop 1" style={{ width: "100%", height: "auto", maxHeight: 180, objectFit: "cover" }} /></Box>
              <Box flex={1}><img src="/images/storiesofbizgro/article pictures/OBS_8994.jpg" alt="Bagel Shop 2" style={{ width: "100%", height: "auto", maxHeight: 180, objectFit: "cover" }} /></Box>
              <Box flex={1}><img src="/images/storiesofbizgro/article pictures/OBS_8996.jpg" alt="Bagel Shop 3" style={{ width: "100%", height: "auto", maxHeight: 180, objectFit: "cover" }} /></Box>
            </Flex>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_8962-2.jpg" alt="Bagel Shop Patio 1" style={{ width: "100%", height: "auto", maxHeight: 340, objectFit: "cover" }} /></Box>
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_8966-2.jpg" alt="Bagel Shop Patio 2" style={{ width: "100%", height: "auto", maxHeight: 340, objectFit: "cover" }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_9055.jpg" alt="Bagel Shop Family" style={{ width: "100%", height: "auto", maxHeight: 340, objectFit: "cover" }} /></Box>
          ...
          <Box bg="gray.50" p={{ base: 4, md: 8 }} mb={8} maxW="2xl" mx="auto">
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_7591.jpg" alt="Left to right, Adam, Kim and Aaron Martin of Hoffman Body Shop and Graphics." style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_7551.jpg" alt="Adam at work in the shop" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
          ...
          <Box bg="gray.50" p={{ base: 4, md: 8 }} mb={8} maxW="2xl" mx="auto">
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_7511.jpg" alt="Jarrety's Place" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
          ...
          <Box bg="gray.50" p={{ base: 4, md: 8 }} mb={8} maxW="2xl" mx="auto">
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_7256.jpg" alt="Mason and Aereka Heyde, owners of Manitou Marina" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_7215.jpg" alt="Manitou Marina" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
          ...
          <Box bg="gray.50" p={{ base: 4, md: 8 }} mb={8} maxW="2xl" mx="auto">
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_7131.jpg" alt="Northern Traders owners, Alan and Sandra Bailey…and Roger." style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_7083.jpg" alt="Northern Traders" style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
          ...
          <Box bg="gray.50" p={{ base: 4, md: 8 }} mb={8} maxW="2xl" mx="auto">
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_7369.jpg" alt="Julie Zellers, owner of Glitter Grooming... and her 'assistant' Snoopy." style={{ width: "100%", height: "auto", maxHeight: 400, objectFit: "contain" }} /></Box>
            ...
            <Box mb={4}><img src="/images/storiesofbizgro/article pictures/OBS_7427.jpg" alt="Glitter Grooming" style={{ width: "100%", height: "auto", maxHeight: 600, objectFit: "contain" }} /></Box>
